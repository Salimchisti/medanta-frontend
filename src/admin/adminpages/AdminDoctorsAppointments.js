...
const AdminDoctorsAppointments = () => {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        const response = await axios.get("/api/doctors-appointments"); // API to fetch doctor's appointments
...
export default AdminDoctorsAppointments;
